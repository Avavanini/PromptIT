...
const BuilderPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#0B0D17] overflow-hidden text-[#FFFFFF] relative">
      {/* Top Bar Header */}
      <BuilderHeader
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Sidebar */}
        <div className="w-[320px] shrink-0 flex flex-col border-r border-[#7582B8] bg-[#0B0D17]">
          {/* Sidebar Tabs */}
          <div className="flex border-b border-[#7582B8]">
            <button onClick={()=> setLeftTab("chat")}
              className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs font-medium cursor-pointer transition ${leftTab === "chat" ? "text-[#FF9E5E] border-b-2 border-[#FF9E5E]" : "text-[#7582B8] hover:text-[#FFFFFF]"}`}>
              <MessageSquareIcon size={13} /> Chat
            </button>

            <button onClick={()=> setLeftTab("files")}
              className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs font-medium cursor-pointer transition ${ leftTab === "files" ? "text-[#FF9E5E] border-b-2 border-[#FF9E5E]" : "text-[#7582B8] hover:text-[#FFFFFF]" }`}>
