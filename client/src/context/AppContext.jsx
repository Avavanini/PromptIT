                ...
                const { data } = await api.get(`/api/projects/${id}`)
                 ...
                 if(files.length > 0){
                    setActiveFile((prev)=>{
                        ...
                        if(normalizedFiles.includes(normalizedPrev)) {
                            // Find the exact key from the data to keep it consistent if needed, 
                            // but activeFile is better kept with the leading slash as FileExplorer uses it.
                            return normalizedPrev; 
                        }
                        
                        if(normalizedFiles.includes("/App.js")) return "/App.js";
                        return normalize(files[0]);
                    })
                 }
            } catch (err) {
